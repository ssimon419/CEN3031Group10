...
namespace UnityStandardAssets._2D
{
    public class PlatformerCharacter2D : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            //  m_Anim.SetBool("Wall",wall_check);
        ...
        public void Move(float move, bool crouch, bool jump)
        {
            ...
            //   wall_check = Physics2D.OverlapCircle(m_WallCheck.position, 0.2f, walllayermask);
            ...
            if (!m_Grounded)
            {
                wall_check = Physics2D.OverlapCircle(m_WallCheck.position, 0.3f, walllayermask);
                if (wall_check)
                {
            ...
            if (m_Grounded && wall_sliding) wall_sliding = false;
